...
var G__7672 = z;
if(((24) > (function (){var G__7673 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__7673) : clojure.test.check.random.longs.bit_count.call(null,G__7673));
})())){
return clojure.test.check.random.longs.bit_xor(G__7672,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__7672;
}
});
...
var G__7676 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__7677 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__7676;
ret = G__7677;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7679__$1,cljs.core.cst$kw$state);
var vec__7681 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7681,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7681,(1),null);
