...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__9540){
var map__9541 = p__9540;
var map__9541__$1 = ((((!((map__9541 == null)))?(((((map__9541.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9541.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9541):map__9541);
var m = map__9541__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9541__$1,cljs.core.cst$kw$result);
...
try{var value__9283__auto__ = result;
if(cljs.core.truth_(value__9283__auto__)){
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$pass,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__9283__auto__,cljs.core.cst$kw$message,null], null));
} else {
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$fail,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__9283__auto__,cljs.core.cst$kw$message,null], null));
}

return value__9283__auto__;
}catch (e9543){var t__9325__auto__ = e9543;
return cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$error,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,t__9325__auto__,cljs.core.cst$kw$message,null], null));
}}
});
...
var begin_test_var_method_9545 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test_DASH_var], null));
cljs.test.report.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test], null),((function (begin_test_var_method_9545){
return (function (m){
cljs.core.reset_BANG_(clojure.test.check.clojure_test.last_trial_report,clojure.test.check.impl.get_current_time_millis());

if(cljs.core.truth_(begin_test_var_method_9545)){
return (begin_test_var_method_9545.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_9545.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_9545.call(null,m));
} else {
return null;
}
});})(begin_test_var_method_9545))
);
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__9546){
var map__9547 = p__9546;
var map__9547__$1 = ((((!((map__9547 == null)))?(((((map__9547.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9547.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9547):map__9547);
var report_map = map__9547__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9547__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_property);
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__9549){
var map__9550 = p__9549;
var map__9550__$1 = ((((!((map__9550 == null)))?(((((map__9550.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9550.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9550):map__9550);
var vec__9551 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9550__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_trial);
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9551,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9551,(1),null);
if((so_far > (0))){
...
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__9555) : cljs.test.report.call(null,G__9555));
});
...
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__9556) : cljs.test.report.call(null,G__9556));
});
