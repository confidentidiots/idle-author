...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9463){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9464,G__9465,seq9463__$2);
});
...
var map__9470 = m;
var map__9470__$1 = ((((!((map__9470 == null)))?(((((map__9470.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9470.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9470):map__9470);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9470__$1,cljs.core.cst$kw$file);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9470__$1,cljs.core.cst$kw$line);
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9470__$1,cljs.core.cst$kw$column);
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__9470,map__9470__$1,file,line,column){
return (function (p1__9469_SHARP_){
return cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__9469_SHARP_));
});})(map__9470,map__9470__$1,file,line,column))
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__9472 = cljs.core.cst$kw$expected.cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__9472) : formatter_fn.call(null,G__9472));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__9473 = cljs.core.cst$kw$actual.cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__9473) : formatter_fn.call(null,G__9473));
})()], 0));
});
...
var temp__5457__auto___9474 = cljs.core.cst$kw$message.cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9474)){
var message_9475 = temp__5457__auto___9474;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_9475], 0));
} else {
}
...
var temp__5457__auto___9476 = cljs.core.cst$kw$message.cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9476)){
var message_9477 = temp__5457__auto___9476;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_9477], 0));
} else {
}
...
var output_dir = "/Users/juanuys/.boot/cache/tmp/Users/juanuys/Documents/clicker-games/idle-author/1vur/ozpa12/index.html.out";
var output_dir__$1 = (function (){var G__9478 = output_dir;
if(!(clojure.string.ends_with_QMARK_(output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9478),"/"].join('');
} else {
return G__9478;
}
})();
...
var G__9480 = exception.stack;
var G__9480__$1 = (((G__9480 == null))?null:clojure.string.split_lines(G__9480));
var G__9480__$2 = (((G__9480__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__9480__$1,depth));
if((G__9480__$2 == null)){
return null;
} else {
return clojure.string.trim(G__9480__$2);
}
} else {
...
var vec__9481 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9481,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9481,(1),null);
var vec__9484 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9484,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9484,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9484,(2),null);
...
var m__$1 = (function (){var G__9487 = cljs.core.cst$kw$type.cljs$core$IFn$_invoke$arity$1(m);
...
var G__9490 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6012__auto__,temp__5457__auto__){
return (function (){
var G__9491 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__9491) : cljs.test.run_block.call(null,G__9491));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__9490) : obj.call(null,G__9490));
} else {
var G__9493 = (function (){var G__9492 = cljs.core.rest(fns);
if(cljs.core.truth_(cljs.core.cst$kw$cljs$test_SLASH_block_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(obj)))){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__9492);
} else {
return G__9492;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__9494,cljs.core.assoc,cljs.core.cst$kw$cljs$test_SLASH_block_QMARK_,true);
}
});
...
}catch (e9495){var e = e9495;
var G__9496 = e;
var G__9496__$1 = (((G__9496 instanceof cljs.core.Keyword))?G__9496.fqn:null);
switch (G__9496__$1) {
...
return (function (g){
var G__9498 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__9498) : f1.call(null,G__9498));
});
});
/**
...
var vec__9499 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9499,(0),null);
var types = vec__9499;
...
var G__9503 = type;
var G__9504 = cljs.core.cst$kw$async;
var fexpr__9502 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$map,cljs.core.cst$kw$async,cljs.core.cst$kw$fn,cljs.core.cst$kw$sync], null);
return (fexpr__9502.cljs$core$IFn$_invoke$arity$2 ? fexpr__9502.cljs$core$IFn$_invoke$arity$2(G__9503,G__9504) : fexpr__9502.call(null,G__9503,G__9504));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__9505){
var vec__9506 = p__9505;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9506,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9506,(1),null);
return ((function (vec__9506,ns,vars__$1){
return (function (){
...
var G__9509 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1){
return (function (){
var G__9511 = ((function (each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1){
return (function (){
var seq__9512 = cljs.core.seq(vars__$1);
var chunk__9513 = null;
var count__9514 = (0);
var i__9515 = (0);
while(true){
if((i__9515 < count__9514)){
var v = chunk__9513.cljs$core$IIndexed$_nth$arity$2(null,i__9515);
var temp__5457__auto___9519 = cljs.core.cst$kw$test.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5457__auto___9519)){
var t_9520 = temp__5457__auto___9519;
var G__9516_9521 = ((function (seq__9512,chunk__9513,count__9514,i__9515,t_9520,temp__5457__auto___9519,v,each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_9520)));
});})(seq__9512,chunk__9513,count__9514,i__9515,t_9520,temp__5457__auto___9519,v,each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__9516_9521) : each_fixture_fn.call(null,G__9516_9521));
} else {
}


var G__9522 = seq__9512;
var G__9523 = chunk__9513;
var G__9524 = count__9514;
var G__9525 = (i__9515 + (1));
seq__9512 = G__9522;
chunk__9513 = G__9523;
count__9514 = G__9524;
i__9515 = G__9525;
...
var G__9526 = cljs.core.chunk_rest(seq__9512__$1);
var G__9527 = c__4351__auto__;
var G__9528 = cljs.core.count(c__4351__auto__);
var G__9529 = (0);
seq__9512 = G__9526;
chunk__9513 = G__9527;
count__9514 = G__9528;
...
var v = cljs.core.first(seq__9512__$1);
var temp__5457__auto___9530__$1 = cljs.core.cst$kw$test.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5457__auto___9530__$1)){
var t_9531 = temp__5457__auto___9530__$1;
var G__9517_9532 = ((function (seq__9512,chunk__9513,count__9514,i__9515,t_9531,temp__5457__auto___9530__$1,v,seq__9512__$1,temp__5457__auto__,each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_9531)));
});})(seq__9512,chunk__9513,count__9514,i__9515,t_9531,temp__5457__auto___9530__$1,v,seq__9512__$1,temp__5457__auto__,each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__9517_9532) : each_fixture_fn.call(null,G__9517_9532));
} else {
}


var G__9533 = cljs.core.next(seq__9512__$1);
var G__9534 = null;
var G__9535 = (0);
var G__9536 = (0);
seq__9512 = G__9533;
...
});})(each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1))
;
var fexpr__9510 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__9510.cljs$core$IFn$_invoke$arity$1 ? fexpr__9510.cljs$core$IFn$_invoke$arity$1(G__9511) : fexpr__9510.call(null,G__9511));
});})(each_fixture_fn,G__9509,G__9509__$1,env,once_fixtures,each_fixtures,vec__9506,ns,vars__$1))
], null);
...
var G__9537 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,cljs.core.cst$kw$end_DASH_test_DASH_vars,cljs.core.cst$kw$vars,vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__9537) : cljs.test.report.call(null,G__9537));
})], null)));
});
/**
