...
(def data
  {
    :product
    {
      ...
      :levels
      {
        ...
        [
          {:key :genesis :cost 0}
          {:key :poem :cost 500 :ticker "You've invented the poem."}
          {:key :knowledge :cost 5000 :ticker "After all these words, you're suddenly concerned with preserving knowledge."}
          {:key :journalism :cost 5000000 :ticker "You've invented Journalism. Bring your own soapbox!"}
    ...
    :tool
    {
      ...
      :levels
      {
        :items
        [
          {:key :genesis :cost 0 :ticker "You've just crawled out of the ocean and find a stick. Something urges you to draw in the sand..."}
          {:key :stone-age :cost 500 :ticker "Sand washes away quickly. Good thing you've discovered the walls in your little cave."}
          {:key :modern :cost 5000 :ticker "Ah, the modern age."}]}
